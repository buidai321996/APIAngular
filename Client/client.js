...
app.get('/studentPagging/:pageNumber/:pageSize',(req,res)=>{
 ...
 app.get('/studentFind/:pageNumber/:pageSize/:textSearch',(req,res)=>{
    var sql="CALL FilterStudentPagging(?,?,?)";
    conntection.query(sql,[req.params.pageNumber,req.params.pageSize,req.params.textSearch],(err,rows)=>{
     if(err) console.log("Error get");
     else{
         console.log(rows)
         res.send({rows});
 ...
 app.get('/FindStudent/:textSearch',(req,res)=>{
